    ...
    return (
      <div className={`${selectedTheme.bodyBgClass} text-white min-h-screen flex flex-col items-center justify-center p-4`}>
        <div className="text-center mb-12">
          <h1 className="font-['Press_Start_2P'] text-6xl text-blue-400 mb-4 text-shadow-lg animate-pulse">
            TETRIS
          </h1>
          <p className="text-xl text-gray-400">Beautiful Tetris Game</p>
        </div>
  ...
  return (
    <div className={`flex flex-col lg:flex-row items-center justify-center min-h-screen ${selectedTheme.bodyBgClass} text-white p-4 gap-8`}>
      ...
      <div className="relative order-1 lg:order-2">
        ...
        />
        {(gameOver || isPaused) && (
          <div className="absolute inset-0 bg-black bg-opacity-80 flex flex-col items-center justify-center p-4 rounded-xl z-10 backdrop-blur-sm">
            {gameOver ? (
